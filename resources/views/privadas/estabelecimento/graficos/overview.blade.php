...
@section('headPainel')
  ...
  {{-- meta --}}
  <meta name="keywords" content="{{ trans('mensagens.meta-dashboard') }}">
  <title>{{ trans('mensagens.titulo-dashboard-overview') }}</title>
  <meta name="Description" content="{{ trans('mensagens.descricao-dashboard-overview') }}">
@endsection
