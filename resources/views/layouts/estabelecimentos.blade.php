      ...
      <div class="row" id="menu-topo-row">
        <div class="visible-xs col-xs-12" id="menu-topo">
          <ul class="nav nav-pills">
            <li role="presentation"><a href="#">{{ trans('mensagens.voltar') }}</a></li>
            <li class="dropdown" role="presentation">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                {{ trans('mensagens.outros') }} <span class="caret"></span>
              </a>
              <ul class="dropdown-menu" id="menu-topo-hidden">
                @include('includes.privadas.estabelecimentos.outrosItensMenu')
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="row">
        <div class="hidden-xs col-sm-3 col-lg-2" id="menu-lateral">
          ...
          <ul class="nav nav-pills nav-stacked">
            <li class="btn btn-primary"><a href="#" style="color: #FFFFFF;">{{ trans('mensagens.voltar') }}</a></li>
